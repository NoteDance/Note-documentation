...
class kernel:
    def __init__(self,nn=None):
        ...
        self.epoch=None  #Training epoch count.
    ...
    #Turn training data into kernel's instance object and initialize some objects.
    ...
    #Initialize shared data for process.
    def init(self,manager):
        self.epoch_counter=Value('i',self.epoch_counter)  #epoch counter,train7 function returns when epoch counter is equal to epoch.
        self.batch_counter=Array('i',self.batch_counter)  #batch counter,train7 function will do some work when the batch counter sum is equal to batches.
        self.total_loss=Array('f',self.total_loss)  #For calculating loss.
        ...
        self.param=manager.dict()  #A dictionary to store optimized parameters.
        return
