...
class DQN:
    def __init__(self,state_dim,hidden_dim,action_dim):
        ...
        self.param=self.nn.param   #parameter list,kernel uses this list for backpropagation.
    ...
    def loss(self,s,a,next_s,r,d): #loss functino,kernel uses this to calculate loss.
